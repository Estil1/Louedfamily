          ...
          <div className="col-12 col-lg-7 col-xxl-7 offset-xxl-1">
            <div className="testimonial-two__content section__content testimonial-g-con">
              <span className="sub-title">
                Loued Family Record Label
                <i className="fa-solid fa-arrow-right"></i>
              </span>
              <h2 className="title title-anim">
                Offering Music Distribution, Marketing, and Publishing Strategy
              </h2>
              <div className="quote">
                    ...
                    <div className="testimonial-two__slider-single">
                      <div className="paragraph">
                        <blockquote className="secondary-text">
                          <q>
                            Welcome to Loued Family Record Label. We specialize in
                            offering music distribution, marketing, and publishing strategy
                            to help artists succeed in the music industry.
                          </q>
                        </blockquote>
                      </div>
