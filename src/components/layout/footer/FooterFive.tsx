          ...
          <div className="col-12 col-lg-5 col-xl-4">
            <div className="footer-two__left">
              ...
              <div className="paragraph">
                <p>
                  Welcome to Loued Family, a record label offering music distribution, marketing, and publishing strategy. We specialize in helping artists like you succeed in the music industry.
                </p>
              </div>
              <div className="section__content-cta">
                <h2>
                  <Link
                    href="mailto:contact@louedfamily.com"
